...
Also, there could not be partial water being spread out evenly on more than 1 grid block - each
unit of water has to be in exactly one block.
...
console.log(pourWater([2,1,1,2,1,2,2], 4, 3), 'and the answer is [2,2,2,3,2,2,2]')
console.log(pourWater([1,2,3,4], 2, 2), 'and the answer is [2,3,3,4]')
console.log(pourWater([3,1,3], 5, 1), 'and the answer is [4,4,4]')
