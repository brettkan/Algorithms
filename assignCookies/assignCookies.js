...
var findContentChildren = function(g, s) {
    ...
    while (pointS < sortedS.length && pointG < sortedG.length) {
        if (sortedG[pointG] <= sortedS[pointS]) {
            pointS++
            pointG++
        } else {
            pointS++
...
// console.log(findContentChildren([1,2,3], [1,1]), 'should be 1')
// console.log(findContentChildren([1,2], [1,2,3]), 'should be 2')
// console.log(findContentChildren([10,9,8,7], [10,9,8,7]), 'should be 4')
